layui.define(["jquery", "layer", "laytpl", "element", "form"],
function (e) {
    var x = layui.$,
    l = layui.layer,
    w = layui.laytpl,
    ...
    u = function () {
        ...
        this.sysName = "LarryMS",
        this.tit = [this.sysName + "提示您", this.sysName + "错误提示", this.sysName + "参数配置错误提示", this.sysName + "数据源配置错误", "关闭失败提示", "操作成功", "操作失败", this.sysName + " Ajax 调试信息控制台"],
        this.config = {
            plusDir: "/common/plus/",
            jqDefined: undefined,
            jqUrl: undefined
    ...
    u.prototype.placeholder = function () {
        var e = this,
        r = "";
        x("input.larryms-input,.larryms-textarea,input.larry-input[type='text'],input.larry-input[type='password']").on("focus",
        function () {
            r = x(this).attr("placeholder");
            x(this).attr("placeholder", "")
        });
        x("input.larryms-input,.larryms-textarea,input.larry-input[type='text'],input.larry-input[type='password']").on("blur",
        function () {
    ...
    u.prototype.plugin = function (e, r, t) {
        ...
        if (typeof e == "string") {
            ...
            if (!this.config.jqDefined) {
                ...
                var f = this.config.jqUrl + this.config.jqDefined,
                d = y.getElementsByTagName("head")[0];
    ...
    u.prototype.sysExportConsole = function (e, r, t, n) {
        var a = this,
        n = n || a.sysName;
        colors = ["red", "green", "blue", "#ff5722"],
        debugC = colors[Math.ceil(Math.random() * 4) - 1];
    ...
    u.prototype.open = function (e, r) {
        ...
        if (r === "current") {
            ...
            if (!n.shadeClose) {
                x("#layui-layer-shade" + a).on("click",
                function () {
                    l.min(a);
                    x(this).hide();
    ...
    u.prototype.escape2Html = function (e) {
        ...
        return e.replace(/&(lt|gt|nbsp|amp|quot);/gi,
        function (e, r) {
            return t[r]
        })
    };
    ...
    u.prototype.content = function (e, t) {
        ...
        function (e) {
            var r = e.replace(/(\<ol class=\"layui-code-ol\"\>)([\s\S]*?)(\<\/ol\>)/g,
            function (e, r, t, n) {
                return li = e.replace(/(\<li\>)([\s\S]*?)(\<\/li\>)/g,
                function (e, r, t) {
                    console.log(t);
                    console.log(r);
        ...
        }).replace(/@(\S+)(\s+?|$)/g, '<a href="/jump.html?name=$1" class="fly-aite">@$1</a>$2').replace(/face\[([^\s\[\]]+?)\]/g,
        function (e) {
    ...
    u.prototype.typeFn = {
        ...
        browserType: function () {
            ...
            if (t) {
                ...
                if (c == 7) return "IE7";
                else if (c == 8) return "IE8";
                else if (c == 9) return "IE9";
                else if (c == 10) return "IE10";
                else return "IE7以下"
            }
            if (n) return "IE11";
            if (a) return "Edge";
    ...
    u.prototype.utils = {
        fixbar: function (t) {
            var e = "larryms-fixbar",
            r = "larryms-fixbar-top",
            n = x(document),
            a = x("body"),
            i,
            o;
        ...
        getUrlAllParams: function (e) {
            ...
            i = t.length; a < i; a++) {
                ...
                s = window.decodeURIComponent(t[a].substring(o + 1));
                n[l] = s
            }
            return n
        },
    ...
    u.prototype.getValue = function (e) {
        var r = this,
        t = "";
        var n = r.elemCheck(e, "larry-form-getValue"),
        a = n.attr("type");
        switch (a) {
            case "text":
                t = n.attr("value");
    ...
    u.prototype.panel = function () {
        x(".larry-panel .tools").off("click").on("click",
        function () {
        ...
        x(".larry-panel .close").off("click").on("click",
        function () {
    ...
    u.prototype.notice = function (e, r, t, n) {
        ...
        var u = "",
        f = "";
        if (o.action == 1) { } else if (o.action == 2) {
            if (o.opentype == 1) {
        ...
        function v(e) {
            ...
            if (o.type == 1) {
                ...
                x(e).find(".larryms-notice-box .larryms-msg-close").on("click",
                function () {
    ...
    u.prototype.player = function (e) {
        ...
        x(r.audioElm).get(0).addEventListener("ended",
        function () {
            x(r.audioElm).remove()
        },
        false);
