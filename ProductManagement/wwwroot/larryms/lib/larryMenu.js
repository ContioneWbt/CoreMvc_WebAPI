...
function (a) {
            ...
            this.oncontextmenu = function (a) {
                ...
                if (e) {
                    ...
                    if (n < a.clientX + f.params.offsetX + l) {
                        ...
                        e.find("ul li").children("div.larryMenuBox").css({
                            top: "-35px",
                            left: -(l + 2)
                        })
                    } else {
    ...
    i.prototype.htmlCreateMenu = function (a) {
        var l = this;
        var t = a || l._data,
        e = a ? Math.random().toString() : l.params.name,
        o = "",
        r = "",
        f = "larry_menu_";
            ...
            function (a, t) {
                ...
                if (c.isArray(t)) {
                    ...
                    function (a, t) {
                        ...
                        r = "",
                        i = "",
                        n = Math.random().toString().replace(".", "");
                        if (e) {
    ...
    i.prototype.funLarryMenu = function () {
        ...
        if (!t.size()) {
            ...
            c(a + e.params.name + " a").bind("click",
            function () {
                var a = c(this).attr("data-key"),
                t = d.data("func")[a];
                if (c.isFunction(t)) {
