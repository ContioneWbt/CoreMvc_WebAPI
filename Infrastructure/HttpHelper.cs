...
namespace Infrastructure
{
    ...
    public class HttpHelper
    {
        ...
        /// <para>hcc2016 2016-3-3 重构与post同样异步调用</para>
        /// </summary>
        ...
        /// <para>hcc2016-07-20 19:01:59</para>
        /// </summary>
        ...
        /// Post Dic数据
        /// <para>最终以formurlencode的方式放置在http体中</para>
        /// <para>hcc2016-07-15 15:28:41</para>
        /// </summary>
        /// <returns>System.String.</returns>
        ...
        /// <summary>
        /// 把请求的URL相对路径组合成绝对路径
        /// <para>hcc2016-07-21 9:54:07</para>
        /// </summary>
        ...
        public void Test()
        {
            HttpHelper httpHelper = new HttpHelper("https://corehrapi.italent.link");

            string result = httpHelper.Post(new
            {
                Parameters = new List<int>() { 274399 },
                AppCode = "960"

            }, $"/api/100045/113629100/Org/GetByOIds");

            var mresult = httpHelper.PostDic(new Dictionary<string, string>()
           {
               { "Parameters","274399"},
               { "AppCode","960"}
